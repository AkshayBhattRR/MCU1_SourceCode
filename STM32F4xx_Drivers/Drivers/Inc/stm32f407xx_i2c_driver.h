 ...
 * @I2C_SCLSpeed
 */
#define	I2C_SCL_SPEED_SM	100000	//SM = Slow mode
...
/*
 * @TxRxState for the typedef : I2C_Handle_t
 */
#define	I2C_READY			0
...
void I2C_MasterReceiveData(I2C_Handle_t *pI2CHandle, uint8_t *pTxBuffer, uint32_t Len, uint8_t SlaveAddr, uint8_t I2C_RS_EnorDI);
